...
public interface IGitHubClient
{
    ...
    public Task<GitItem> GetItem(string itemPath);

    /// <summary>
    /// Get a list of all items in the given GitHub directory.
    /// </summary>
    /// <param name="directory">The directory  to look in.</param>
    /// <returns>A list of all the items in a given directory, null if the directory did not exist.</returns>
    public Task<IEnumerable<GitItem>> GetItems(string directory);
}